...
<head>
    ...
    <link rel="stylesheet" href="purecss/pure-min.css" integrity="sha384-oAOxQR6DkCoMliIh8yFnu25d7Eq/PHS21PClpwjOTeU2jRSq11vu66rf90/cZr47" crossorigin="anonymous">
        ...
        <![endif]-->
        <!--[if gt IE 8]><!-->
            <link rel="stylesheet" href="purecss/side-menu.css">
        <!--<![endif]-->
    <!--[if lt IE 9]>
